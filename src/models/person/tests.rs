...
mod tests {
    ...
    async fn test_update_person() {
        use crate::models::person::{
            create::Create, read::get_person_by_id_optional, update::Update,
        };
    ...
    async fn test_delete_person() {
        use crate::models::person::{
            create::Create, delete::Delete, read::get_person_by_id_optional,
        };
        ...
        for _ in 0..10 {
            ...
            match &mut person_from_db {
                Some(person_from_db) => {
                    ...
                    let check_if_inexistent =
                        query!("SELECT * FROM persons WHERE id = $1", person.id)
                            .fetch_optional(&pool)
                            .await
